 ...
 * File path:   app/code/local/Aitoc/Aitoptionstemplate/Model/Observer.php
 * Copyright:   (c) 2013 AITOC, Inc.
 */
?>
<?php if(Aitoc_Aitsys_Abstract_Service::initSource(__FILE__,'Aitoc_Aitoptionstemplate')){ DjWDWrkwrRjjjjZU('e71e3cbbed8235b2be55dfb8db045b91'); ?><?php
