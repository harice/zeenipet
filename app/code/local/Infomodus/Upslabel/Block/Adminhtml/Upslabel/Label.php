...
class Infomodus_Upslabel_Block_Adminhtml_Upslabel_Label extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function getHeaderText()
    {
        if( Mage::registry('upslabel_data') && Mage::registry('upslabel_data')->getId() ) {
            return Mage::helper('upslabel')->__("Label '%s'", $this->htmlEscape(Mage::registry('upslabel_data')->getTitle()));
        } else {
