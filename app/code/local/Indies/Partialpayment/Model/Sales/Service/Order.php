 ...
 */
class Indies_Partialpayment_Model_Sales_Service_Order extends Mage_Sales_Model_Service_Order
{
    /**
     * Order object
     *
    ...
    public function prepareInvoice($qtys = array())
    {
		...
		$invoice->setSubtotal($this->_order->getSubtotal());
		$invoice->setBaseSubtotal($this->_order->getBaseSubtotal());
		$invoice->setSubtotalInclTax($this->_order->getSubtotalInclTax());
		$invoice->setBaseSubtotalInclTax($this->_order->getBaseSubtotalInclTax());
		$invoice->setGrandTotal($this->_order->getGrandTotal());
		$invoice->setBaseGrandTotal($this->_order->getBaseGrandTotal());
		$invoice->setDepositAmount($this->_order->getDepositAmount());
		$invoice->setBaseDepositAmount($this->_order->getBaseDepositAmount());
		$invoice->setOutstockDiscountAmount($this->_order->getOutstockDiscountAmount());
		$invoice->setBaseOutstockDiscountAmount($this->_order->getBaseOutstockDiscountAmount());
		$invoice->setFeeAmount($this->_order->getFeeAmount());
		$invoice->setBaseFeeAmount($this->_order->getBaseFeeAmount());
