<?php
class Indies_Fee_Block_Sales_Order_Total extends Mage_Core_Block_Template
{
    /**
    ...
    public function initTotals()
    {
		...
		if($partialpaymentHelper->isApplyToWholeCart())
				$condition =(((float) $this->getOrder()->getFeeAmount() > 0) && ($this->getOrder()->getDepositAmount() > 0) && ($this->getOrder()->getSubtotalIncl() >= $partialpaymentHelper->getMinimumOrderAmount()) && ($this->getOrder()->getGrandTotal() > $this->getOrder()->getFeeAmount()));
			else
