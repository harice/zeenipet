...
class Indies_Support_Block_Adminhtml_Support_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  ...
  protected function _prepareColumns()
  {
      ...
      $this->addColumn('title', array(
          'header'    => Mage::helper('support')->__('Title'),
          'align'     =>'left',
          'index'     => 'title',
      ));
      ...
      $this->addColumn('content', array(
			'header'    => Mage::helper('support')->__('Item Content'),
			'width'     => '150px',
			'index'     => 'content',
      ));
	  */
      ...
      $this->addColumn('status', array(
          'header'    => Mage::helper('support')->__('Status'),
          'align'     => 'left',
          'width'     => '80px',
          'index'     => 'status',
          'type'      => 'options',
		...
		$this->addExportType('*/*/exportCsv', Mage::helper('support')->__('CSV'));
		$this->addExportType('*/*/exportXml', Mage::helper('support')->__('XML'));
