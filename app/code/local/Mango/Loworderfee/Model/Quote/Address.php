    ...
    public function validateMinimumAmount() {
        ...
        if (!Mage::getStoreConfigFlag('sales/minimum_order/active', $storeId)) {
            return true;
                ...
                $low_qty = false;
        $validateQty = Mage::getStoreConfig('sales/minimum_order/low_order_fee_qty', $storeId);
        if($validateQty && $this->getItemQty()<$validateQty ) $low_qty = true;
        ...
        if ($low_qty || $_amount_to_compare < $amount) {
            return false;
        }
