...
class Mango_Loworderfee_Model_Observer extends Mage_Core_Model_Abstract {
    ...
    public function sales_quote_collect_totals_after(Varien_Event_Observer $observer) {
     ...
     $address->setGrandTotal($address->getGrandTotal() + $_fee);
      $address->setBaseGrandTotal($address->getBaseGrandTotal() + $_fee);

			$address->setSubtotal($address->getSubtotal() + $_fee);
      $address->setBaseSubtotal($address->getBaseSubtotal() + $_fee);
      }
     /*   echo "<pre/>";
        print_r($address->getData());*/
      /*$address->setTotalAmount($address->getTotalAmount() + $_fee);
    $address->setBaseTotalAmount($address->getBaseTotalAmount() + $_fee);
*/
