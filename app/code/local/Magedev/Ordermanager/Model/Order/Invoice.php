...
class Magedev_Ordermanager_Model_Order_Invoice extends Mage_Sales_Model_Order_Invoice
{  
    ...
    public static function getStates()
    {
		...
		// echo '<pre>';print_r( self::$_states);die;
			...
			$invoiceStatus = Mage::getStoreConfig('orderview/opermission/edit_order_invoice_status'); 
