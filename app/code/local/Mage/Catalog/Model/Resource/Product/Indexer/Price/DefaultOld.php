...
//-------------------------
//------ Ishtiaq ------
        $minPriceAbs     = new Zend_Db_Expr("({$optPriceValue})");
        $minPriceAbsExpr = $write->getCheckSql("{$optPriceType} = 'absolute'", $minPriceAbs, $minPriceExpr);
...
//-------------------------
//------ Ishtiaq ------
        $tierPriceAbs     = new Zend_Db_Expr("({$optPriceValue})");
        $tierPriceAbsExpr = $write->getCheckSql("{$optPriceType} = 'absolute'", $tierPriceAbs, $tierPriceExpr);
        $tierPriceExpr    = $tierPriceAbsExpr;
//------ Ishtiaq ------^^^
//-------------------------
...
//-------------------------
//------ Ishtiaq ------
        $groupPriceAbs    = new Zend_Db_Expr("({$optPriceValue})");
        $groupPriceAbsExpr= $write->getCheckSql("{$optPriceType} = 'absolute'", $groupPriceAbs, $groupPriceExpr);
        $groupPriceExpr   = $groupPriceAbsExpr;
//------ Ishtiaq ------^^^
//-------------------------
...
//-------------------------
//------ Ishtiaq ------
        $maxPriceAbs    = new Zend_Db_Expr("({$optPriceValue})");
        $maxPriceAbsExpr= $write->getCheckSql("{$optPriceType} = 'absolute'", $maxPriceAbs, $maxPriceExpr);
...
//-------------------------
//------ Ishtiaq ------
        $_max_price   = new Zend_Db_Expr('i.max_price + io.max_price');
        $_tier_price  = $write->getCheckSql('i.tier_price IS NOT NULL', 'i.tier_price + io.tier_price', 'NULL');
//------ Ishtiaq ------^^^
//-------------------------
...
//------ Ishtiaq ------
			...
			'max_price'   => $write->getCheckSql('i.tier_price IS NOT NULL', $_tier_price, $_max_price),
//------ Ishtiaq ------^^^
//-------------------------
    ...
    /**
     * Move Final Prices index to primary temporary index table
     *
     * @return Mage_Catalog_Model_Resource_Product_Indexer_Price_Default
     */
