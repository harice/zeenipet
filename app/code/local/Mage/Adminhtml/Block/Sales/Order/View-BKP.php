...
class Mage_Adminhtml_Block_Sales_Order_View extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function __construct()
    {
        ...
        $this->_addButton('order_production', array(
                'label'     => Mage::helper('sales')->__('production'),
                'onclick'   => 'window.open(\'http://'.$_SERVER['SERVER_NAME'].'/myscripts/production-order.php?invoiceNo=' . $this->getOrder()->getRealOrderId() . '\')',
                'class'     => 'go'
            ));
    }
