 ...
 */
  class Aitoc_Aitoptionstemplate_Model_Mysql4_Product_Option_Price extends Mage_Core_Model_Mysql4_Abstract
{
    protected function _construct()
    {
        $this->_init('catalog/product_option_price','option_price_id');
